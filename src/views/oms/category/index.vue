<template>
  <div class="app-container">
    ...
    >
      <el-table-column prop="categoryName" label="分类名称" :show-overflow-tooltip="true" width="160"></el-table-column>
...
<script>
import { listCategory, getCategory, delCategory, saveCategory, updateCategory } from "@/api/oms/category";
